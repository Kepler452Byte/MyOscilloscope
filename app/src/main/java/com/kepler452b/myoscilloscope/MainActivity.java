...
/*        //测surface的宽和高
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.black_background) {
            Toast.makeText(this, "您点击了“黑色背景”", Toast.LENGTH_SHORT).show();
        } else if (id == R.id.white_background) {
    ...
    public void onClick(View view) {
        ...
        else if (id == R.id.btn_x_axis_reduce)
        {        xAxisResolutionChanged.onClick(btn_x_axis_reduce);
                ...
                GetBluetoothDataService.sendChar(0x0d);
                GetBluetoothDataService.sendChar(0x0a);}
        else if (id == R.id.btn_y_axis_add)
                yAxisResolutionChanged.onClick(btn_y_axis_add);
        else if (id == R.id.btn_y_axis_reduce)
        {        yAxisResolutionChanged.onClick(btn_y_axis_reduce);}
        else if (id == R.id.btn_rising_trigger)
                triggerMode = true;
        else if (id == R.id.btn_normal_trigger)
        {       triggerMode = false;}
        else if (id == R.id.btn_out_sin_wave)
        {        out_wave_type = OUT_SIN_FLAG;
                ...
                GetBluetoothDataService.sendChar(0x0d);
                GetBluetoothDataService.sendChar(0x0a);}
        else if (id == R.id.btn_out_rect_wave)
